...
from swagger_client.models.get_tax_result import GetTaxResult


class TestGetTaxResult(unittest.TestCase):
    """ GetTaxResult unit test stubs """
    ...
    def testGetTaxResult(self):
        """
        Test GetTaxResult
        """
        model = swagger_client.models.get_tax_result.GetTaxResult()
