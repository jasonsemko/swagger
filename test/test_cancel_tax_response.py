...
from swagger_client.models.cancel_tax_response import CancelTaxResponse


class TestCancelTaxResponse(unittest.TestCase):
    """ CancelTaxResponse unit test stubs """
    ...
    def testCancelTaxResponse(self):
        """
        Test CancelTaxResponse
        """
        model = swagger_client.models.cancel_tax_response.CancelTaxResponse()
