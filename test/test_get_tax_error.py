...
from swagger_client.models.get_tax_error import GetTaxError


class TestGetTaxError(unittest.TestCase):
    """ GetTaxError unit test stubs """
    ...
    def testGetTaxError(self):
        """
        Test GetTaxError
        """
        model = swagger_client.models.get_tax_error.GetTaxError()
