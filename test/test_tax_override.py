...
from swagger_client.models.tax_override import TaxOverride


class TestTaxOverride(unittest.TestCase):
    """ TaxOverride unit test stubs """
    ...
    def testTaxOverride(self):
        """
        Test TaxOverride
        """
        model = swagger_client.models.tax_override.TaxOverride()
