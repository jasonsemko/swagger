...
from swagger_client.models.cancel_tax_unauthorized_error import CancelTaxUnauthorizedError


class TestCancelTaxUnauthorizedError(unittest.TestCase):
    """ CancelTaxUnauthorizedError unit test stubs """
    ...
    def testCancelTaxUnauthorizedError(self):
        """
        Test CancelTaxUnauthorizedError
        """
        model = swagger_client.models.cancel_tax_unauthorized_error.CancelTaxUnauthorizedError()
