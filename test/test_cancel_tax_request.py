...
from swagger_client.models.cancel_tax_request import CancelTaxRequest


class TestCancelTaxRequest(unittest.TestCase):
    """ CancelTaxRequest unit test stubs """
    ...
    def testCancelTaxRequest(self):
        """
        Test CancelTaxRequest
        """
        model = swagger_client.models.cancel_tax_request.CancelTaxRequest()
