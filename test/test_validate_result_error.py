...
from swagger_client.models.validate_result_error import ValidateResultError


class TestValidateResultError(unittest.TestCase):
    """ ValidateResultError unit test stubs """
    ...
    def testValidateResultError(self):
        """
        Test ValidateResultError
        """
        model = swagger_client.models.validate_result_error.ValidateResultError()
