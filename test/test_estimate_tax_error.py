...
from swagger_client.models.estimate_tax_error import EstimateTaxError


class TestEstimateTaxError(unittest.TestCase):
    """ EstimateTaxError unit test stubs """
    ...
    def testEstimateTaxError(self):
        """
        Test EstimateTaxError
        """
        model = swagger_client.models.estimate_tax_error.EstimateTaxError()
