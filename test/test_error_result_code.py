...
from swagger_client.models.error_result_code import ErrorResultCode


class TestErrorResultCode(unittest.TestCase):
    """ ErrorResultCode unit test stubs """
    ...
    def testErrorResultCode(self):
        """
        Test ErrorResultCode
        """
        model = swagger_client.models.error_result_code.ErrorResultCode()
