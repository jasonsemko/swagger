...
from swagger_client.models.get_tax_request import GetTaxRequest


class TestGetTaxRequest(unittest.TestCase):
    """ GetTaxRequest unit test stubs """
    ...
    def testGetTaxRequest(self):
        """
        Test GetTaxRequest
        """
        model = swagger_client.models.get_tax_request.GetTaxRequest()
