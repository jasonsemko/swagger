...
from swagger_client.models.estimate_tax_result import EstimateTaxResult


class TestEstimateTaxResult(unittest.TestCase):
    """ EstimateTaxResult unit test stubs """
    ...
    def testEstimateTaxResult(self):
        """
        Test EstimateTaxResult
        """
        model = swagger_client.models.estimate_tax_result.EstimateTaxResult()
