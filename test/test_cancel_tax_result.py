...
from swagger_client.models.cancel_tax_result import CancelTaxResult


class TestCancelTaxResult(unittest.TestCase):
    """ CancelTaxResult unit test stubs """
    ...
    def testCancelTaxResult(self):
        """
        Test CancelTaxResult
        """
        model = swagger_client.models.cancel_tax_result.CancelTaxResult()
